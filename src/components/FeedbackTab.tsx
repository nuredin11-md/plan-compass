...
import { FileDown, TrendingUp, TrendingDown, AlertTriangle, CheckCircle2, Target, MessageSquareText, AlertCircle, TrendingUpIcon } from "lucide-react";
...
export default function FeedbackTab({ monthlyData }: Props) {
  ...
  const displayedPeriodic = selectedArea === "all" ? periodicFeedback : periodicFeedback.filter((d) => d.area === selectedArea);
